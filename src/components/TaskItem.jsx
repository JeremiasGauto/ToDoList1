  ...
  return (
    <MagicMotion>
      <div className={task.completado ? bgDone : comun}>
        ...
        <p className=" text-blue-900 grid justify-items-center items-center break-all overflow-hidden w-14 md:w-full">
          <span className="font-bold text-blue-900  grid justify-items-center items-center text-xs break-all w-80% overflow-hidden w-14 md:w-full">
            {" "}
            Fecha:{" "}
          </span>
          {task.fecha}
